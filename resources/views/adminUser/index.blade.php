...
<li class="nav-item ">
  <a class="nav-link" href="{{ route('otrosservicios.index') }}">Otros servicios</a>
          ...
          <li class="nav-item">
            <a class="nav-link active" href="{{route ('users_admin.index')}}">Usuarios</a>
          </li>
          <li class="nav-item ">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="text-center">
                                    ...
                                    <a href="{{url('/users_admin/'.$user['id_user'].'/edit')}}" class="btn btn-primary btnEditar">Editar</a>
                            ...
                            <td>
                              ...
                              <form action="{{url('/user/elim/'.$user['id_user'])}}" method="post">
