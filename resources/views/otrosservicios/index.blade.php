...
<li class="nav-item ">
  <a class="nav-link active" href="{{ route('otrosservicios.index') }}">Otros servicios</a>
</li>
<li class="nav-item ">
      ...
      <ul class="navbar-nav ">
        <li >
          <div  class="button" >
            ...
            <a href="{{ route('otrosservicios.create') }}">Registrar Otro servicio</a>
          </div>
          </li>
        ...
        <div class="table-responsive text-center  cardIndex border animate__animated  animate__zoomInUp ">
            ...
            <table class="table table-bordered ">
                ...
                <tbody>
                    ...
                    @foreach ($otrosserviciosArray as $otrosservicio)
                        <tr>

                            <th scope="row">{{ $otrosservicio['id'] }}</th>
                            <td>{{ $otrosservicio['nombre'] }}</td>
                            <td>{{ $otrosservicio['direccion'] }}</td>
                            <td>{{ $otrosservicio['telefono'] }}</td>
                      
                            <td>

                                <div class="text-center">

                                    <a href="{{url('/otrosservicios/'.$otrosservicio['id'].'/edit')}}" class="btn btn-primary btnEditar">Editar</a>
                            ...
                            <td>
                              ...
                              <form action="{{url('/otrosservicios/elim/'.$otrosservicio['id'])}}" method="post">
