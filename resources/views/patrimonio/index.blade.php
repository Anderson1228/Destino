        ...
        <div class="container-fluid ">
            ...
            <div class="collapse navbar-collapse d-flex justify-content-center " id="navbarNav">
                <ul class="navbar-nav ">
                    ...
                    <li class="nav-item ">
                      <a class="nav-link active" href="{{ route('patrimonio.index') }}">Patrimonio</a>
                  </li>
                  <li class="nav-item ">
            ...
            <ul class="navbar-nav ">
                <li>
                    <div class="button">
                        ...
                        <a href="{{ route('patrimonio.create') }}">Registrar patrimonio</a>
                    </div>
                </li>
            ...
            <div class="table-responsive text-center  cardIndex border animate__animated  animate__zoomInUp ">
                ...
                <table class="table table-bordered ">
                    ...
                    <tbody>
                        ...
                        @foreach ($patrimonioArray as $patrimonio)
                            <tr>

                                <th scope="row">{{ $patrimonio['id_patrimonio'] }}</th>
                                <td>{{ $patrimonio['nombre'] }}</td>
                                <td>{{ $patrimonio['fecha_creacion'] }}</td>
                                <td>{{ $patrimonio['descripcion'] }}</td>
                                <td>{{ $patrimonio['direccion'] }}</td>
                                ...
                                <td>
                                    ...
                                    <div class="text-center">
                                        ...
                                        <a href="{{ url('/patrimonio/editar_patrimonio/' . $patrimonio['id_patrimonio']) }}"
                                ...
                                <td>
                                    ...
                                    <form action="{{ url('/patrimonio/elim/' . $patrimonio['id_patrimonio']) }}" method="post">
