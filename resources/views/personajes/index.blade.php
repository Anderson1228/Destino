    ...
    <div class="container-fluid ">
      ...
      <div class="collapse navbar-collapse d-flex justify-content-center " id="navbarNav">
        <ul class="navbar-nav ">
          ...
          <li class="nav-item ">
            <a class="nav-link active" href="{{ route('personajes.index') }}">Personajes</a>
        </li>
        <li class="nav-item ">
        ...
        <div class="table-responsive text-center  cardIndex border animate__animated  animate__zoomInUp ">
            ...
            <table class="table table-bordered ">
                ...
                <tbody>
                    ...
                    @foreach ($personajesArray as $personaje)
                        <tr>

                            <th scope="row">{{ $personaje['id_personaje'] }}</th>
