    ...
    <nav class="navbar navbar-expand-lg navbar-light  bg-dark navbar-dark animate__animated animate__slideInDown"
        ...
        <div class="container-fluid ">
            ...
            <div class="collapse navbar-collapse d-flex justify-content-center " id="navbarNav">
                ...
                <li class="nav-item ">
                  <a class="nav-link active" href="{{ route('historia.index') }}">Historia</a>
              </li>
              <li class="nav-item ">
            ...
            <ul class="navbar-nav ">
                <li>
                    <div class="button">
                        ...
                        <a href="{{ route('historia.create') }}">Registrar historia</a>
                    </div>
                </li>
...
@section('content')
    ...
    <div class="container py-5 ">
        ...
        @endif
        @isset($historiaArray)
        <H1>Recuerde que solamante será visible la ultima historia agregada o editada.</H1>
        <br><br>
            <div class="table-responsive text-center  cardIndex border animate__animated  animate__zoomInUp ">
                ...
                <table class="table table-bordered  ">
                    ...
                    <tbody>
                        ...
                        @foreach ($historiaArray as $historia)
                            <tr>

                                <th scope="row">{{ $historia['id_historia'] }}</th>
                                <td >{{ $historia['title'] }}</td>
                                <td >{{ $historia['link_ubicacion'] }}</td>
                                ...
                                <td>
                                    ...
                                    <div class="text-center">
                                        ...
                                        <a href="{{ url('/historia/editar_historia/' . $historia['id_historia']) }}"
                                ...
                                <td>
                                    ...
                                    <form action="{{ url('/historia/elim/' . $historia['id_historia']) }}" method="post">
