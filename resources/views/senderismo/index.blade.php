    ...
    <nav class="navbar navbar-expand-lg navbar-light  bg-dark navbar-dark animate__animated animate__slideInDown"
        ...
        <div class="container-fluid ">
            ...
            <div class="collapse navbar-collapse d-flex justify-content-center " id="navbarNav">
              ...
              <li class="nav-item ">
                <a class="nav-link active" href="{{ route('senderismo.index') }}">Senderismo</a>
            </li>
            <li class="nav-item ">
            ...
            <ul class="navbar-nav ">
                <li>
                    <div class="button">
                        ...
                        <a href="{{ route('senderismo.create') }}">Registrar senderismo</a>
                    </div>
                </li>
            ...
            <div class="table-responsive text-center  cardIndex border animate__animated  animate__zoomInUp ">
                ...
                <table class="table table-bordered  ">
                    ...
                    <tbody>
                        ...
                        @foreach ($senderismoArray as $senderismo)
                            <tr>

                                <th scope="row">{{ $senderismo['id_senderismo'] }}</th>
                                <td >{{ $senderismo['nombre'] }}</td>
                                <td >{{ $senderismo['caracteristica'] }}</td>
                                <td >{{ $senderismo['link_ubicacion'] }}</td>
                                <td>{{ $senderismo['descripcion'] }}</td>
                                ...
                                <td>
                                    ...
                                    <div class="text-center">
                                        ...
                                        <a href="{{ url('/senderismo/editar_senderismo/' . $senderismo['id_senderismo']) }}"
                                ...
                                <td>
                                    ...
                                    <form action="{{ url('/senderismo/elim/' . $senderismo['id_senderismo']) }}" method="post">
